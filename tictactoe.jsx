const Board = () => {
  ...
  let playerT = `Next Play: ${player == '0' ? 'Player O' : 'Player X'}`;
  ...
  return (
    <div className="game-board">
      ...
      <div id="info">
        ...
        <h1 id="turn">{playerT}</h1>
        <h1 className="neon">{status}</h1>
      </div>
    </div>
  );
};
...
const checkForWinner = (gameState) => {
  if (gameState.length < 5) return 'undetermined';
